...
#        params.gravityComp = False
#        params.ffwdOn = False        
#        p.des_forcesW, p.Wffwd, p.Wfbk, p.Wg = projectionBasedController(conf.control_params[p.robot_name], act_state, des_state, p.feetPosW, p.stance_legs, params)
...
#        p.des_forcesW, p.Wffwd, p.Wfbk, p.Wg = projectionBasedController(conf.control_params[p.robot_name], act_state, des_state, p.feetPosW, p.stance_legs, params)
        ...
        p.des_forcesW, p.Wffwd, p.Wfbk, p.Wg, p.constr_viol =  QPController(conf.control_params[p.robot_name], act_state, des_state, p.feetPosW, p.stance_legs, params)
...
#        p.des_forcesW, p.Wffwd, p.Wfbk, p.Wg, p.constr_viol =  QPController(conf.control_params[p.robot_name], act_state, des_state, p.feetPosW, p.stance_legs, params)                                           
       ...
       # send desired command to the ros controller     
        ...
        for leg in range(4):
            ...
            p.ros_pub.add_arrow(p.feetPosW[leg], p.u.getLegJointState(leg, p.des_forcesW/(5*p.robot.robotMass())),"blue")        
